...
% first, train the rbm
    ...
    my_rbm = optimize([n_hid, 1], ...
                     @(my_rbm, data) cd1(my_rbm, data.inputs), ...  % discard labels % data_sets.training, 
                      train,...
                     lr_rbm, ...
                     n_iterations);
    ...
    hidden_representation = logistic(input_to_hid * train);% data_sets.training.inputs);
    % train hid_to_class
